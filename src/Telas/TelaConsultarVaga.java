 ...
 * @author Gleidson
 */
public class TelaConsultarVaga extends javax.swing.JFrame {
    ...
    public TelaConsultarVaga(ArrayList<Sessao> sessao, ArrayList<Filme> filme){
        this.sessao = sessao;
        this.filme = filme;
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel5.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Sessoes com assentos disponiveis", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 12))); // NOI18N
    ...
    private void botapPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botapPesquisarActionPerformed
        ...
        modelo.setNumRows(0);
            ...
            if (sessao.get(i).getCapacidadeSessao()>0 && selecionarData.getSelectedItem().toString().equals(sessao.get(i).getData())){
            modelo.addRow(new Object []{
