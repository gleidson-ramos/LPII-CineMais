 ...
 * @author Gleidson
 */
public class TelaCadastroSessao3D extends javax.swing.JFrame {
    ...
    public TelaCadastroSessao3D(ArrayList<Filme> filme, ArrayList<Sala3D> sala3d, ArrayList<Sessao> sessao) {
        initComponents();
        this.filme = filme;
        this.sessao = sessao;
        this.sala3d = sala3d;
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Cadastrar Sessão 3D", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 18))); // NOI18N
        ...
        selecionarSala.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
        selecionarSala.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                selecionarSalaMouseClicked(evt);
            }
        });

        selecionarFilme.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        ...
        for (Sala3D s3: sala3d){
            selecionarSala.addItem(String.valueOf(s3.getNumeroSala()));
        }
    ...
    private void botaoSalvarSessaoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botaoSalvarSessaoActionPerformed
        ...
        if (sala3d.get(i).getCapacidadeSala() < capacidade){
            //limita a capacidade da sessão a capacidade da sala
            capacidade = sala3d.get(i).getCapacidadeSala();
            JOptionPane.showMessageDialog(null, "A capacidade da sessão foi definida como "+capacidade);
        }

        
        s = new Sessao(txtHorario.getText(), capacidade, txtData.getText(),sala3d.get(selecionarSala.getSelectedIndex()), filme.get(selecionarFilme.getSelectedIndex()));
    ...
    private void selecionarSalaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_selecionarSalaMouseClicked
        selecionarSala.getSelectedIndex();
    }//GEN-LAST:event_selecionarSalaMouseClicked
